function Kymograph = makeExpandKymograph(movie4D, pos_spots, first_frame, last_frame, voxel_size, time_step, sp_exp_width, n_exp, channelType)
	...
	plot(spots_pos_on_kymograph(first_frame:last_frame, 2)*interp_step, times, 'b.', 'LineWidth',1);
