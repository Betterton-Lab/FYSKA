function Kymograph = makeSegmentKymograph(movie4D, pos_spots, first_frame, last_frame, voxel_size, time_step, channelType)
    ...
    Kymograph = zeros( (last_frame - first_frame + 1), interp_step21 + interp_step23 );
    ...
    for frame_number = first_frame:last_frame
        ...
        hold on; 
        plot(spot1_pos(1),spot1_pos(2),"ro",'MarkerSize',5,'LineWidth',1);
        plot(spot2_pos(1),spot2_pos(2),"go",'MarkerSize',5,'LineWidth',1);
        plot(spot3_pos(1),spot3_pos(2),"bo",'MarkerSize',5,'LineWidth',1);
        plot(end_pos1(1),end_pos1(2),"rx",'MarkerSize',5,'LineWidth',1);
        plot(end_pos2(1),end_pos2(2),"gx",'MarkerSize',5,'LineWidth',1);
        plot(end_pos3(1),end_pos3(2),"bx",'MarkerSize',5,'LineWidth',1);
	...
	plot(spots_pos_on_kymograph(first_frame:last_frame, 1)*(interp_step21+interp_step23+2), times, 'r.', 'LineWidth',1);
	plot(spots_pos_on_kymograph(first_frame:last_frame, 2)*(interp_step21+interp_step23+2), times, 'g.', 'LineWidth',1);
    plot(spots_pos_on_kymograph(first_frame:last_frame, 3)*(interp_step21+interp_step23+1), times, 'b.', 'LineWidth',1);
